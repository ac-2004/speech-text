...
public class StatisticsControllerTest {
	...
	// MockMvc lets us simulate HTTP requests without launching a real web server on
	// port 8080.
	@Autowired
	...
	void getGlobalStats_whenServiceFails_returnsStandard500Error() throws Exception {
		...
		// ARRANGE:
		// Force the mocked statistics service to fail so we can verify that the global
		// exception handler produces the standard YAML error shape.
